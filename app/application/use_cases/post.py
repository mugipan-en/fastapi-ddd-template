...
class PostUseCases:
    ...
    def __init__(self, post_service: PostService, post_repository: PostRepository, user_repository: UserRepository):
    ...
    async def get_post_by_id(self, post_id: int, user_id: Optional[int] = None) -> Optional[Post]:
    ...
    async def get_post_by_slug(self, slug: str, user_id: Optional[int] = None) -> Optional[Post]:
    ...
    async def get_all_posts(self, skip: int = 0, limit: int = 100, user_id: Optional[int] = None) -> List[Post]:
    ...
    async def get_user_posts(self, author_id: int, requester_id: Optional[int] = None, skip: int = 0, limit: int = 100) -> List[Post]:
    ...
    async def get_posts_by_status(self, status: PostStatus, requester_id: int, skip: int = 0, limit: int = 100) -> List[Post]:
    ...
    async def get_posts_by_tags(self, tags: List[str], skip: int = 0, limit: int = 100) -> List[Post]:
    ...
    async def get_post_statistics(self, requester_id: int) -> Dict[str, Any]:
        ...
        published_count = await self.post_repository.count_by_status(PostStatus.PUBLISHED)
    ...
    async def get_user_post_statistics(self, user_id: int, requester_id: int) -> Dict[str, Any]:
    ...
    async def get_trending_posts(self, days: int = 7, limit: int = 10) -> List[Post]:
        ...
        trending_posts = sorted(published_posts, key=lambda p: p.view_count, reverse=True)
