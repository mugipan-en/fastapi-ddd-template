...
class PostService:
    ...
    async def create_post(self, post_data: PostCreate, user_id: int) -> Post:
        ...
        return await self.post_repository.create(
            PostCreate.model_validate(post_dict), user_id
        )
    ...
    async def get_post_with_view_increment(self, post_id: int) -> Post | None:
    ...
    async def get_user_posts_stats(self, user_id: int) -> dict:
        ...
        published_posts = await self.post_repository.count_by_status(
