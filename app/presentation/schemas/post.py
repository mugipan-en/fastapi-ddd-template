...
class PostResponse(BaseModel):
    ...
    tags: Optional[str] = Field(description="Post tags")
    ...
    updated_at: Optional[datetime] = Field(description="Post last update timestamp")
    published_at: Optional[datetime] = Field(description="Post publication timestamp")
...
class PostCreateRequest(BaseModel):
    ...
    status: Optional[PostStatus] = Field(default=PostStatus.DRAFT, description="Post status")
    tags: Optional[str] = Field(default=None, max_length=500, description="Post tags")


class PostUpdateRequest(BaseModel):
    """Post update request schema."""
    title: Optional[str] = Field(default=None, min_length=1, max_length=200, description="Post title")
    content: Optional[str] = Field(default=None, min_length=1, max_length=10000, description="Post content")
